...
INSERT INTO `tblpname` (`pnid`, `pname`) VALUES
(1, 'Kamran Fayyaz'),
(2, 'Kamran Fayyaz'),
(3, 'Christine Smith'),
(4, 'James Edgar'),
...
INSERT INTO `tblprofessor` (`pid`, `pname`, `pemail`, `pcourse`, `puniversity`) VALUES
...
INSERT INTO `tblpuniversity` (`puid`, `puniversity`) VALUES
(1, 'College Park'),
(2, 'UMBC'),
(3, 'UMGC'),
(4, 'Towson'),
...
INSERT INTO `tblrating` (`rid`, `p_fk`, `rdate`, `rrating`, `rdifficulty`, `rtag`, `ragain`, `rcomments`) VALUES
