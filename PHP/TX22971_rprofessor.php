...
$sql1 = "SELECT * from TX22971_tblprofessor where pid=$pid";
...
echo "</Td><Td>";
$sql = "SELECT * from TX22971_tblnews LEFT JOIN TX22971_tblcategory ON TX22971_tblnews.newscatid = TX22971_tblcategory.catid";
