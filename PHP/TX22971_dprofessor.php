...
?>	
				...
				$sql = "SELECT pid, pname, pcourse, puniversity,p_fk, rdate, rrating, rdifficulty, rtag,   ragain, rcomments from TX22971_tblprofessor JOIN TX22971_tblrating ON TX22971_tblprofessor.pid = TX22971_tblrating.p_fk Where TX22971_tblrating.p_fk=$id order by rid desc";
				//echo $sql;
...
if($count>=1){ 
				...
				<Div class=rateP> <a href= TX22971_rprofessor.php?pid=$id>Rate Professor ".$pname." </a> <Div>
				</Div></Td>
				<Td>";
				include ("TX22971_chartratingD.php");
				echo "</Td>
				</Tr>";
				echo "";
